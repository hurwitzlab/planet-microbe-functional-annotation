...
class Pipeline:
    def __init__(self, config, input_file, out_dir):
        ...
        self.centrifuge_executable_fp = os.environ.get(
            'centrifuge',
            default=
            '/xdisk/bhurwitz/mig2020/rsgrps/bhurwitz/alise/tools/centrifuge/centrifuge'
        )
        self.centrifuge_kraken_executable_fp = os.environ.get(
            'centrifuge-kreport',
            default=('/xdisk/bhurwitz/mig2020/rsgrps/bhurwitz/'
                     'alise/tools/centrifuge/centrifuge-kreport'))
